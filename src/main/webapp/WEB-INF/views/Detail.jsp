...
<div id="body">
    ...
    <div id="header">
        <ul>
            ...
            <li class="heart_none"><input type="image" name="heart_none" src="${pageContext.request.contextPath}/assets/image/heart_none.png"></li>
            <li class="heart"><input type="image" name="heart" src="${pageContext.request.contextPath}/assets/image/heart.png"></li>
        </ul>
    </div>
    ...
    <div id="content">
        ...
        <div class="explanation">
            ...
            <div class="collapse-item">
                <span><a href="QnA.do">Q&A</a></span>
            </div>
        </div>
    </div>

    <div id="footer">
     <a id="insertCart" href="#">쇼핑백담기</a>
     <a href="Payment.do">바로주문</a>
    </div>
</div>
    
    <div id="modal">
        <div id="upperArea">
            <img id="modalClose" src="image/close2.png">
        </div>
        <div id="lowerArea">
            <form action="${pageContext.request.contextPath}/cartInsert.do" name="form1" method="post">
                ...
                <div id="formDelivery">
                    	배송방법<br/>
				                    택배<input type="radio" name="delivery" value="택배" />
				                    방문수령<input type="radio" name="delivery" value="방문수령" />
	            </div>
                <div id="formCount">
                    <div id="numberChange">

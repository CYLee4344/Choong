...
<div id="bottom_bar">
    <ul>
        ...
        <li><a href="MyHeart.do"><img src="assets/image/heart.png"></a></li>
        <li>
        	<c:if test="${user != null}"><a href="MyPage.do"><img src="assets/image/person.png"></a></c:if>
        	<c:if test="${user == null}"><a href="Login.do"><img src="assets/image/person.png"></a></c:if>
        </li>
    </ul>
</div>
